...
# with command line options: Configuration/GenProduction/python/SMP-RunIISummer20UL17pp5TeVwmLHEGS-00007-fragment.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --conditions 106X_mc2017_realistic_forppRef5TeV_v3 --beamspot Fixed_EmitRealistic5TeVppCollision2017 --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(53) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017_ppRef --python_filename SMP-RunIISummer20UL17pp5TeVwmLHEGS-00007_1_cfg.py --fileout file:SMP-RunIISummer20UL17pp5TeVwmLHEGS-00007.root --number 100 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIISummer20UL17pp5TeVwmLHEGS-00007-fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL17pp5TeVwmLHEGS-00007.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL17pp5TeVwmLHEGS-00007_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'BiasedTauDecayer:eDecays = on', 
            'BiasedTauDecayer:muDecays = on'
        ),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/pp/5p02TeV/powheg/Vj_MiNNLO/Wj_slc7_amd64_gcc10_CMSSW_12_3_1_WplusJToTauNu-5p02TeV-suggested-nnpdf31-ncalls-doublefsr-q139-ckm-powheg-MiNNLO31-svn3900-ew-rwl6-j200-st2fix-ana-hoppetweights-ymax20-pdf3.tgz'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(53)
