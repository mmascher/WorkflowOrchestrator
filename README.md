...
| **`scripts/`** | Executables used on the worker: **execute_stepchain.sh** runs the full stepchain (request tarball + one `jobN.json`); **stageout.py** transfers files to the site storage element. See [ep_scripts/README.md](ep_scripts/README.md). |
