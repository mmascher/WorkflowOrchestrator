...
| **`scripts/`** | Executable used on the worker: takes the request tarball and one `jobN.json`, runs the full stepchain. See [ep_scripts/README.md](ep_scripts/README.md). |
